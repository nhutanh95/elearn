        ...
        <div className="card rounded-10 shadow-base bd-0">
            <div className="card-body d-flex align-items-center justify-content-between bd-0-f pd-20">
                <div className="flex-shrink-0 d-flex flex-column justify-content-between">
                    ...
                    <p className="tx-14 text-center mg-b-0 tx-medium">{!isLoading ? (title) : (<Skeleton />)}</p>
                    <a className="tx-12" href={link ? link : ''} >{!isLoading ? (linkTitle) : (<Skeleton />)}</a>
                </div>
                        ...
                        <div className="gv-situation mg-b-15">
                            ...
                            <div className="row">
                                <div className="col-12 col-md-4 mg-b-15">
                                    <SituationBlock isLoading={isLoading} link={dashboardInfo?.OpenSlotURL} linkTitle="Manage slot" title="Slots Opened" value={dashboardInfo?.OpenSlot} unit="slots" imageUrl={'../assets/img/slot-open.png'} />
                                </div>
                                <div className="col-12 col-md-4  mg-b-15">
