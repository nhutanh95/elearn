...
const NoteForStudentModal = () => {
    ...
    return (
        <>
            <div className="modal effect-scale" tabIndex={-1} role="dialog" id="js-md-note">
                                ...
                                <div className="required-list mg-t-15 bd-t pd-t-15">
                                    <div className="required-text-box mg-t-15">
                                        ...
                                        <div className="form-group">
                                            <textarea rows={4} className="form-control" defaultValue={note} onChange={setNote} plcaeholder="Note..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
