            ...
            <div className="col-md-6">
              ...
              <div className="form-row align-items-center">
                ...
                <div className="form-group col-sm-9">
                  ...
                  {
                    errors.Language && <span className="text-danger d-block mt-2">{errors.Language.message}</span>
                  }
                </div>
              </div>
            </div>
            <div className="col-md-6">
              ...
              <div className="form-row align-items-center">
                ...
                <div className="form-group col-sm-9">
                  ...
                  {
                    errors.TimeZoneID && <span className="text-danger d-block mt-2">{errors.TimeZoneID.message}</span>
                  }
                </div>
              </div>
            </div>
            ...
            <div className="col-12">
              <div className="form-row  align-items-center ">
                ...
                <div className="form-group col-sm-9">
                  ...
                  {
                    errors.SkypeID &&
                    <span className="text-danger d-block mt-2">{errors.SkypeID.message}</span>
                  }
                </div>
              </div>
            </div>
